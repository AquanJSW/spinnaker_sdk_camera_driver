...
// blaze
#include "basler_blaze/ExecuteCommand.h"
...
class Capture : public nodelet::Nodelet {
  ...
  private:
    ...
    void dynamicReconfigureCallback(
        spinnaker_sdk_camera_driver::spinnaker_camConfig &config,
        uint32_t level);
    ...
    time_t time_now_;
    double grab_time_, save_time_, toMat_time_, save_mat_time_,
        export_to_ROS_time_, achieved_time_;
    ...
    void
    assignTimeStampCallback(const trigger_msgs::sync_trigger::ConstPtr &msg);
    struct SyncInfo_ {
        uint32_t latest_imu_trigger_count_;
        ros::Time latest_imu_trigger_time_;
    };
    ...
    dynamic_reconfigure::Server<
        spinnaker_sdk_camera_driver::spinnaker_camConfig> *dynamicReCfgServer_;
    ...
    // blaze
    ros::ServiceClient client_blaze;
    basler_blaze::ExecuteCommand srv;
